...
Publication.create(user_id: 1, effective_date: (DateTime.now + 10.months).strftime("%d/%m/%Y"),end_date: (DateTime.now + 10.months + 1.months).strftime("%d/%m/%Y"), operation: "Alquiler", address: "Quesada, Buenos Aires, Argentina", floor: 4, apartment: "2", number_spaces: 2, surface: 140, price: 7200.0, expenses: 200.0, antiquity: 50, description: "", additional_info: "", created_at: "2014-09-14 17:38:48", updated_at: "2014-09-14 17:38:48", currency_id: 1, neighbourhood_id: 14, property_type_id: 3,plan_id: 3,status: 2)
p = Publication.create(user_id: 1, effective_date: (DateTime.now).strftime("%d/%m/%Y"),end_date: (DateTime.now + 1.months).strftime("%d/%m/%Y"), operation: "Alquiler", address: "Quesada, Buenos Aires, Argentina", floor: 8, apartment: "31", number_spaces: 4, surface: 90, price: 7800.0, expenses: 300.0, antiquity: 10, description: "", additional_info: "", created_at: "2014-09-14 17:38:48", updated_at: "2014-09-14 17:38:48", currency_id: 1, neighbourhood_id: 6, property_type_id: 3,plan_id: 3,status: 2)

p.update(effective_date: (DateTime.now - 15.days).strftime("%d/%m/%Y"),end_date: (DateTime.now - 15.days + 1.months).strftime("%d/%m/%Y"))
